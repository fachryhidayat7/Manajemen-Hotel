      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <div class="box box-info">
            ...
            <form class="form-horizontal" action="<?php echo base_url(). 'data_master/update_vendor'; ?>" method="POST">
              <div class="box-body">
                <div class="form-group">
                  <div class="col-sm-10">
                    <input type="hidden" class="form-control" id="id_vendor" placeholder="Id" name="id_vendor" value="<?= $row->id_vendor?>">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label">Nama Suplier</label>
                  <div class="col-sm-10">
                    <input type="text" name="nama_vendor" class="form-control" placeholder="Nama Suplier" value="<?= $row->nama_vendor?>">
                  </div>
                </div>
                  <div class="form-group">
